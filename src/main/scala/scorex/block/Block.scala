...
case class Block private(override val timestamp: Long,
  ...
  protected val signatureValid: Coeval[Boolean] = Coeval.evalOnce(GostSign.verify(signerData.signature.arr, bytesWithoutSignature(), signerData.generator.publicKey))
