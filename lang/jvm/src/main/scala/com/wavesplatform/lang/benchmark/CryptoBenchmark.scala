...
class CryptoBenchmark {
  ...
  @Benchmark
  def sha256_test(): Array[Byte] = Global.sha256(randomBytes(DataBytesLength))

  @Benchmark
  def keccack256_test(): Array[Byte] = Global.keccack256(randomBytes(DataBytesLength))

  @Benchmark
  def blake2b256_test(): Array[Byte] = Global.blake2b256(randomBytes(DataBytesLength))
